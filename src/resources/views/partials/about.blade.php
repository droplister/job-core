...
<p class="text-muted small lh-135">
    If this is your first time to {{ config('job-core.domain') }}, we recommend checking out our <a href="{{ route('alerts.index') }}">free job alerts</a>. And, in addition, we have listed below several resources which can help you while applying for {{ strtolower(config('job-core.keyword')) }}.
</p>
