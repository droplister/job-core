    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="row">
            <div class="col-md-9">
                ...
                @elseif(config('job-core.filter') === 'federal')
                    <p class="text-muted small lh-135 pt-3 mb-0">
                        <a href="https://www.youtube.com/watch?v=8YX7o1PBoFk">
                            VIDEO from USAJOBS.gov on writing your resume
                        </a>
                    </p>
                    <p class="text-muted small lh-135 pt-2 mb-0">
                        <a href="https://my.usajobs.gov/Content/pdfs/Tutorials-Resume.pdf">
                    ...
                    <p class="text-muted small lh-135 pt-2 pb-2 mb-0">
                        <a href="https://www.govloop.com/resources/10-tips-for-letting-federal-employers-know-your-worth-infographic/">
