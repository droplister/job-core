    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="row">
            <div class="col-12 col-md-9">
                <p class="text-muted small lh-135">1. This website is not endorsed by, or associated with, any government agency. {{ config('job-core.domain') }} is privately owned by <a href="https://familymediallc.com/">Family Media LLC</a>. Family Media publishes free internet resources for niche audiences online. If you have any questions, please <a href="{{ route('contact.create') }}">contact us</a>.</p>
